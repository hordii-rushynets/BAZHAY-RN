...
type PremiumProfileAdvertProps = {
    onButtonPress: () => void;
}

export default function PremiumProfileAdvert({ onButtonPress }: PremiumProfileAdvertProps) {
    ...
    return (
        <View style={styles.premiumProfileAdvertContainer}>
            ...
            <SubmitButton onPress={onButtonPress} width={304} style={styles.premiumProfileAdvertButton} textStyle={styles.premiumProfileAdvertButtonText}>{staticData.main.premiumProfileAdvert.button}</SubmitButton>
